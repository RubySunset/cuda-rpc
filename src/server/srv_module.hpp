...
public:
    ...
    static std::shared_ptr<gpu_Module> factory(uint64_t module_id, CUcontext& ctx, char* buffer, size_t size
...
public:
    ...
    gpu_Module(uint64_t module_id, CUcontext& ctx,  char* buffer, size_t size, std::weak_ptr<test::gpu_Context> vctx);
