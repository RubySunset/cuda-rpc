...
template<class... Args>
core::future<void> Function::call(Stream& stream, std::array<size_t, 6>& gpu_grid, Args&&... ker_args) {
    using msg = ::service::compute::cuda::wire::Function::call;
...
template<class... Args>
core::future<void> Function::call(Stream& stream, std::pair<size_t, size_t>& gpu_grid, Args&&... ker_args) {
    using msg = ::service::compute::cuda::wire::Function::call;
