...
std::string
srv::wire::to_string(const core::receive_args<srv::wire::Context::memcpy_async::request>& obj)
{
    using msg = std::remove_cvref_t<decltype(obj)>;
...
std::string
srv::wire::to_string(const core::receive_args<srv::wire::Context::memcpy_async::response>& obj)
{
    using msg = std::remove_cvref_t<decltype(obj)>;
...
std::string
srv::wire::to_string(const core::receive_args<srv::wire::Stream::wait_event::request>& obj)
{
    using msg = std::remove_cvref_t<decltype(obj)>;
...
std::string
srv::wire::to_string(const core::receive_args<srv::wire::Stream::wait_event::response>& obj)
{
    using msg = std::remove_cvref_t<decltype(obj)>;
...
std::string
srv::wire::to_string(const core::receive_args<srv::wire::Stream::wait_value_32::request>& obj)
{
    using msg = std::remove_cvref_t<decltype(obj)>;
...
std::string
srv::wire::to_string(const core::receive_args<srv::wire::Stream::wait_value_32::response>& obj)
{
    using msg = std::remove_cvref_t<decltype(obj)>;
...
std::string
srv::wire::to_string(const core::receive_args<srv::wire::Stream::write_value_32::request>& obj)
{
    using msg = std::remove_cvref_t<decltype(obj)>;
...
std::string
srv::wire::to_string(const core::receive_args<srv::wire::Stream::write_value_32::response>& obj)
{
    using msg = std::remove_cvref_t<decltype(obj)>;
...
std::string
srv::wire::to_string(const core::receive_args<srv::wire::Module::destroy::request>& obj)
{
    using msg = std::remove_cvref_t<decltype(obj)>;
...
std::string
srv::wire::to_string(const core::receive_args<srv::wire::Module::destroy::response>& obj)
{
    using msg = std::remove_cvref_t<decltype(obj)>;
...
std::string
srv::wire::to_string(const core::receive_args<srv::wire::Library::get_kernel::request>& obj)
{
    using msg = std::remove_cvref_t<decltype(obj)>;
...
std::string
srv::wire::to_string(const core::receive_args<srv::wire::Library::get_kernel::response>& obj)
{
    using msg = std::remove_cvref_t<decltype(obj)>;
    ...
    print_imm_error(error);
    print_imm_cuerror(cuerror);
    print_imm_hex(cukernel);
    print_extra_imm_error();

    print_cap(req_generic);
    print_extra_cap_error();
...
std::string
srv::wire::to_string(const core::receive_args<srv::wire::Library::destroy::request>& obj)
{
    using msg = std::remove_cvref_t<decltype(obj)>;
...
std::string
srv::wire::to_string(const core::receive_args<srv::wire::Library::destroy::response>& obj)
{
    using msg = std::remove_cvref_t<decltype(obj)>;
...
std::string
srv::wire::to_string(const core::receive_args<srv::wire::Kernel::destroy::request>& obj)
{
    using msg = std::remove_cvref_t<decltype(obj)>;
...
std::string
srv::wire::to_string(const core::receive_args<srv::wire::Kernel::destroy::response>& obj)
{
    using msg = std::remove_cvref_t<decltype(obj)>;
...
std::string
srv::wire::to_string(const core::receive_args<srv::wire::Event::synchronize::request>& obj)
{
    using msg = std::remove_cvref_t<decltype(obj)>;
...
std::string
srv::wire::to_string(const core::receive_args<srv::wire::Event::synchronize::response>& obj)
{
    using msg = std::remove_cvref_t<decltype(obj)>;
...
std::string
srv::wire::to_string(const core::receive_args<srv::wire::Event::record::request>& obj)
{
    using msg = std::remove_cvref_t<decltype(obj)>;
...
std::string
srv::wire::to_string(const core::receive_args<srv::wire::Event::record::response>& obj)
{
    using msg = std::remove_cvref_t<decltype(obj)>;
